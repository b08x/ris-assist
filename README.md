...
| **Knowledge** | Resolved ticket → KCS-style KB article draft; gap detection; stale-article flags. Closes the loop automatically where a ServiceNow MCP connection is available |
